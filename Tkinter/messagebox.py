# For generating an alert, you will use messagebox function showinfo.
# For creating a question, you will use the askquestion method, and based on the response to the question, you will output a Label on the GUI
