# pack(): It organizes the widgets in a block manner, and the complete available width is occupied by it.
# It's a conventional method to show the widgets in the window.
